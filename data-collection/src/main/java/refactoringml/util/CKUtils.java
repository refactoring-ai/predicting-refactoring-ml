...
public class CKUtils {
	...
	public static ClassMetric extractClassMetrics(CKClassResult ck){
		return new ClassMetric(
				...
				ck.getRfc(),
				ck.getLcom(),
				ck.getTightClassCohesion(),
				ck.getLooseClassCohesion(),
	...
	public static MethodMetric extractMethodMetrics(CKMethodResult ckMethodResult){
		return new MethodMetric(
				...
				ckMethodResult.getMethodInvocations().size(),
				ckMethodResult.getMethodInvocationsLocal().size(),
				ckMethodResult.getMethodInvocationsIndirectLocal().keySet().size(),
